...
from benchmark.benchmark_capymoa import capymoa_experiment
from benchmark.benchmark_river import river_experiment
import pandas as pd
...
# Define the datasets
    datasets_path = [
        "./benchmarking_datasets/RTG_2abrupt.arff",
        "./benchmarking_datasets/Hyper100k.arff",
    ]
...
def _river_classification_benchmark():
    # Define the datasets
    datasets_path = [
        "./benchmarking_datasets/RTG_2abrupt.csv",
        "./benchmarking_datasets/Hyper100k.csv",
    ]
...
# Define the datasets
    datasets_path = [
        "./benchmarking_datasets/FriedmanLea.arff",
    ]
...
# Define the datasets
    datasets_path = [
        "./benchmarking_datasets/FriedmanLea.csv",
    ]
