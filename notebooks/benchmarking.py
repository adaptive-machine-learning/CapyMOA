...
def capymoa_experiment(
    ...
    avg_accuracy = sum(result['cumulative'].accuracy() for result in results) / repetitions
    std_accuracy = pd.Series([result['cumulative'].accuracy() for result in results]).std()
...
def river_experiment(
        dataset_name, learner_name, stream_path_csv, learner, hyperparameters={}, repetitions=1
):
    date_time_stamp = datetime.now().strftime("[%Y-%m-%d %H:%M]")
...
def benchmark_classifiers_capymoa(intermediary_results, raw_intermediary_results, data, dataset_names, results_output_csv, raw_results_output_csv):
    ...
    intermediary_results = checkpoint_results(intermediary_results, result_capyNB, results_output_csv)
    raw_intermediary_results = checkpoint_results(raw_intermediary_results, raw_capymoa, raw_results_output_csv)
    ...
    intermediary_results = checkpoint_results(intermediary_results, result_capyHT, results_output_csv)
    raw_intermediary_results = checkpoint_results(raw_intermediary_results, raw_capymoa, raw_results_output_csv)
    ...
    intermediary_results = checkpoint_results(intermediary_results, result_capyEFDT, results_output_csv)
    raw_intermediary_results = checkpoint_results(raw_intermediary_results, raw_capymoa, raw_results_output_csv)
    ...
    intermediary_results = checkpoint_results(intermediary_results, result_capyKNN, results_output_csv)
    raw_intermediary_results = checkpoint_results(raw_intermediary_results, raw_capymoa, raw_results_output_csv)
    ...
    intermediary_results = checkpoint_results(intermediary_results, result_capyARF5, results_output_csv)
    raw_intermediary_results = checkpoint_results(raw_intermediary_results, raw_capymoa, raw_results_output_csv)
    ...
    intermediary_results = checkpoint_results(intermediary_results, result_capyARF10, results_output_csv)
    raw_intermediary_results = checkpoint_results(raw_intermediary_results, raw_capymoa, raw_results_output_csv)
    ...
    intermediary_results = checkpoint_results(intermediary_results, result_capyARF30, results_output_csv)
    raw_intermediary_results = checkpoint_results(raw_intermediary_results, raw_capymoa, raw_results_output_csv)
    ...
    intermediary_results = checkpoint_results(intermediary_results, result_capyARF100, results_output_csv)
    raw_intermediary_results = checkpoint_results(raw_intermediary_results, raw_capymoa, raw_results_output_csv)
    ...
    intermediary_results = checkpoint_results(intermediary_results, result_capyARF100j4, results_output_csv)
    raw_intermediary_results = checkpoint_results(raw_intermediary_results, raw_capymoa, raw_results_output_csv)

    return intermediary_results, raw_intermediary_results


def benchmark_classifiers_river(intermediary_results, raw_intermediary_results, stream_path_csv, dataset_names, results_output_csv, raw_results_output_csv):
    ...
    intermediary_results = checkpoint_results(intermediary_results, result_riverNB, results_output_csv)
    raw_intermediary_results = checkpoint_results(raw_intermediary_results, raw_river, raw_results_output_csv)
    ...
    intermediary_results = checkpoint_results(intermediary_results, result_riverHT, results_output_csv)
    raw_intermediary_results = checkpoint_results(raw_intermediary_results, raw_river, raw_results_output_csv)
    ...
    intermediary_results = checkpoint_results(intermediary_results, result_riverEFDT, results_output_csv)
    raw_intermediary_results = checkpoint_results(raw_intermediary_results, raw_river, raw_results_output_csv)
    ...
    intermediary_results = checkpoint_results(intermediary_results, result_riverKNN, results_output_csv)
    raw_intermediary_results = checkpoint_results(raw_intermediary_results, raw_river, raw_results_output_csv)
    ...
    intermediary_results = checkpoint_results(intermediary_results, result_riverARF5, results_output_csv)
    raw_intermediary_results = checkpoint_results(raw_intermediary_results, raw_river, raw_results_output_csv)
    ...
    intermediary_results = checkpoint_results(intermediary_results, result_riverARF10, results_output_csv)
    raw_intermediary_results = checkpoint_results(raw_intermediary_results, raw_river, raw_results_output_csv)
    ...
    intermediary_results = checkpoint_results(intermediary_results, result_riverARF30, results_output_csv)
    raw_intermediary_results = checkpoint_results(raw_intermediary_results, raw_river, raw_results_output_csv)
    ...
    intermediary_results = checkpoint_results(intermediary_results, result_riverARF100, results_output_csv)
    raw_intermediary_results = checkpoint_results(raw_intermediary_results, raw_river, raw_results_output_csv)
...
def plot_performance(df, plot_prefix):
    ...
    ordered_algorithms = [
        'NaiveBayes', 'HT', 'EFDT', 'kNN', 'ARF5', 'ARF10', 'ARF30', 'ARF100', 'ARF100j4'
    ]
    ...
    common_algorithms = set(capymoa_data['learner']).intersection(set(river_data['learner']))
    ...
    for measure in measures:
        ...
        # Capymoa bars
        capymoa_means = capymoa_data[capymoa_data['learner'].isin(common_algorithms)][f'avg_{measure}']
        capymoa_std = capymoa_data[capymoa_data['learner'].isin(common_algorithms)][f'std_{measure}']
        capymoa_colors = ['green' for _ in range(len(capymoa_means))]
        capymoa_positions = np.arange(len(capymoa_means))
        plt.bar(capymoa_positions - 0.2, capymoa_means, yerr=capymoa_std, width=0.4, color=capymoa_colors, label='capymoa')

        # River bars
        river_means = river_data[river_data['learner'].isin(common_algorithms)][f'avg_{measure}']
        river_std = river_data[river_data['learner'].isin(common_algorithms)][f'std_{measure}']
        river_colors = ['red' for _ in range(len(river_means))]
        river_positions = np.arange(len(river_means))
        plt.bar(river_positions + 0.2, river_means, yerr=river_std, width=0.4, color=river_colors, label='river')

        # X-axis labels
        algorithm_names = capymoa_data[capymoa_data['learner'].isin(common_algorithms)]['learner']
