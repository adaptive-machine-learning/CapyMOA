...
class STEPD(MOADriftDetector):
    ...
    Reference:
    Nishida, Kyosuke, and Koichiro Yamauchi. "Detecting concept drift using statistical testing."
    International conference on discovery science. Berlin, Heidelberg: Springer Berlin Heidelberg, 2007.
