...
class ShrubsRegressor(ShrubEnsembles, Regressor):
    ...
    def __init__(self,
        ...
        """
        Initializes the ShrubsRegressor classifier with the given parameters. 
        Parameters:
        -----------
        schema : Schema
        ...
        additional_tree_options : dict, optional (default={"splitter": "best", "criterion": "gini", "max_depth": None})
            Additional options for the trees, such as splitter, criterion, and max_depth. See sklearn.tree.DecisionTreeRegressor 
        Raises:
        -------
        ValueError
