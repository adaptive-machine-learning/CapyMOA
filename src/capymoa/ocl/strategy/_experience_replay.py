...
class ExperienceReplay(BatchClassifier):
    ...
    * The replay buffer is implemented using reservoir sampling, which allows
    ...
    .. [vitter1985] Jeffrey S. Vitter. 1985. Random sampling with a reservoir. ACM Trans.
    ...
    def __init__(
        ...
        super().__init__(learner.schema, learner.batch_size, learner.random_seed)
    ...
    def batch_train(self, x: np.ndarray, y: np.ndarray) -> None:
        ...
        replay_x, replay_y = self._buffer.sample_n(self.learner.batch_size)
