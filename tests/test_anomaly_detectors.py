...
@pytest.mark.parametrize(
    ...
    [
        ...
        (partial(OnlineIsolationForest, window_size=100, num_trees=32, max_leaf_samples=32), 0.50, None),
        (partial(Autoencoder, hidden_layer=2, learning_rate=0.5, threshold=0.6), 0.57, None),
    ],
    ids=[
        "HalfSpaceTrees",
        "OnlineIsolationForest",
